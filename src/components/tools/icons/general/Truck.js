...
const Truck = (props) => {
    return (
        <svg {...props} fill="currentColor" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
            viewBox="0 0 491.1 491.1" xmlSpace="preserve">
