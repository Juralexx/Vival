...
export default function Breadcrumb(props: Props) {
    ...
    function generateBreadcrumbs() {
        ...
        return [{ href: "/", text: props.denomination ? props.denomination : 'Home' }, ...crumblist, { href: "/" + nestedRoutes, text: current }]
    }

    const breadcrumbs = generateBreadcrumbs()

    return (
        <div className={className ? `av-breadcrumb ${className}` : 'av-breadcrumb'} aria-label="breadcrumb" role="breadcrumb" {...others}>
